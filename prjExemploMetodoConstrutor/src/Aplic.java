...
public class Aplic {
    public static void main(String[] args){
       ...
       do{
           ...
           switch(opcao){                                        
                case 1: System.out.println("Área: " + objRet.calcArea() + " " + objRet.getUnidadeMedida() + "²");
                        break;       
                                                    
                case 2: System.out.println("Perímetro: " + objRet.calcPerimetro() + " " + objRet.getUnidadeMedida());
                        break;
